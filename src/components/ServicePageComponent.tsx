              ...
              <div key={service.id} className="w-full">
                <div className="max-w-screen-xl mx-auto px-6 py-5">
                  <div className="flex flex-wrap lg:flex-nowrap items-center justify-between gap-10">
                    {/* SVG Section */}
                    <div className={`w-full lg:w-1/2 flex justify-center items-center mb-6 lg:mb-0 ${index % 2 !== 0 ? 'lg:order-2' : 'lg:order-1'}`}>
                      <div className="relative w-[300px] h-[300px] sm:w-[350px] sm:h-[350px] lg:w-[460px] lg:h-[480px]">
                        <svg
                    ...
                    <div className={`w-full lg:w-1/2 flex items-center fadeInBottom ${index % 2 !== 0 ? 'lg:order-1' : 'lg:order-2'}`}>
                      <div>
                        ...
                        <h3 className="text-3xl font-bold text-primarycolor mb-6 fadeInBottom">
                          {service.title}
                        </h3>
